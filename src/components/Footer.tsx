            ...
            <div className={classes.container}>
                <div className={classes.mainGrid}>
                    ...
                    <div className={classes.brandColumn}>
                        ...
                        <div className={classes.socialWrapper}>
                            <a href="#" className={`${classes.socialIcon} group`} target="_blank" rel="noopener noreferrer">
                                {/* Instagram Filled */}
                ...
                <div className={classes.bottomBar}>
                    <div className={classes.tagline}>
                        ...
                        <span>Powered by Unicoin Foundation</span>
                        <span className={classes.separator}>|</span>
                        <span>Designed for Women Redefining Wealth</span>
                    </div>

                    <div className={classes.copyright}>
                        &copy; 2026 <span className={classes.copyrightBrand}>Money4Women</span>. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
