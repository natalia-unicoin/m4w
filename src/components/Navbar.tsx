            ...
            >
                <div className={classes.container}>
                    ...
                    <Link href="/" className={classes.logoLink}>
                        <img src={getImagePath("assets/logo-alternative.png")} alt="Money4Women" className={classes.logoImage} style={{ maxHeight: '32px', width: 'auto' }} />
                    </Link>
                        ...
                        >
                            ...
                            <div className={classes.menuLogo}>
                                <Link href="/" onClick={() => setIsMenuOpen(false)}>
                                    <img src={getImagePath('assets/logo-alternative.png')} alt="Money4Women" className="w-full" style={{ maxWidth: '160px' }} />
                                </Link>
                            </div>
